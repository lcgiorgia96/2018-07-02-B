...
public class ExtFlightDelaysDAO {
	...
	public List<Airport> getAer(int x) {
		String sql = "SELECT a.ID, a.IATA_CODE, a.AIRPORT, a.CITY, a.STATE,a.COUNTRY, a.LATITUDE, a.LONGITUDE, a.TIMEZONE_OFFSET " + 
				...
				"GROUP BY a.ID, a.IATA_CODE, a.AIRPORT, a.CITY, a.STATE,a.COUNTRY, a.LATITUDE, a.LONGITUDE, a.TIMEZONE_OFFSET " + 
				"HAVING COUNT( f.FLIGHT_NUMBER) >= ? ";
		List<Airport> result = new ArrayList<Airport>();
		...
		try {
			...
			while (rs.next()) {
				if (idMap.get(rs.getInt("ID1"))!= null && idMap.get(rs.getInt("ID2"))!=null) {
					result.add(new Rotta (idMap.get(rs.getInt("ID1")),idMap.get(rs.getInt("ID2")), rs.getDouble("AVG")));
				}
